...
// Return a Product should equal the sum of the elements in list1 multiplied by 
// the corresponding element in list2
// if one list is longer than the other, the extra list elements are ignored 
//
// Usage: ./prac_q1 List 1 - List 2
// E.g:   ./prac_q1 2 3 4 - 5 5 5 5 5
int product(struct node *head1, struct node *head2) {
    ...
    while (curr1 != NULL && curr2 != NULL) {
        product = product + (curr1->data * curr2->data);
        curr1 = curr1->next;
        curr2 = curr2->next;
    }
